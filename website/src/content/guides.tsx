...
export const guides: Guide[] = [
  {
    ...
    blocks: [
      ...
      { p: "All Done Sites uses the subscription approach. We design and build your site for free to start, then host, secure and update it for one simple monthly fee. There is no large upfront bill, and the recurring costs above are bundled in rather than billed separately." },
