    ...
    >
      ...
      <div className="legal">
        ...
        <div className="toc">
          <h3>Contents</h3>
          <ol>
            <li><a href="#s1">Parties; Effective Date; Order of Precedence</a></li>
            <li><a href="#s2">Definitions</a></li>
            <li><a href="#s3">Scope of Services</a></li>
            <li><a href="#s4">Client Responsibilities</a></li>
            <li><a href="#s5">Ownership; License; Access</a></li>
            <li><a href="#s6">SEO Levels</a></li>
            <li><a href="#s7">Term; Minimum Commitment; Cancellation</a></li>
            <li><a href="#s8">Fees; Invoicing; No Refunds; Taxes</a></li>
            <li><a href="#s9">Non-Payment; Suspension; Data Retention</a></li>
            <li><a href="#s10">Buyout; Transfer to Another Host</a></li>
            <li><a href="#s11">Service Levels; Maintenance; Security</a></li>
            <li><a href="#s12">Content Standards; Compliance; Data Protection</a></li>
            <li><a href="#s13">Additional Work; Changes in Scope</a></li>
            <li><a href="#s14">Confidentiality</a></li>
            <li><a href="#s15">Warranties; Disclaimers; Limitation of Liability</a></li>
            <li><a href="#s16">Force Majeure</a></li>
            <li><a href="#s17">Suspension; Termination for Cause</a></li>
            <li><a href="#s18">Governing Law; Dispute Resolution</a></li>
            <li><a href="#s19">Entire Agreement; Amendments; Assignment; Notices</a></li>
          </ol>
        </div>

        <section id="s1">
          <h2>1. Parties; Effective Date; Order of Precedence</h2>
          <p>
        ...
        <section id="s2">
          ...
          <dl>
            <dt>Branding</dt>
            <dd>The Client's trademarks, logos, colour schemes, fonts, and other brand assets supplied by Client.</dd>
            <dt>Content</dt>
            <dd>Text, images, video, audio and other materials the Client supplies for inclusion on the Website.</dd>
            <dt>Website</dt>
            <dd>The website and related software, templates, themes, components, and configurations created or provided by Provider under the subscription.</dd>
            <dt>Small Content Update</dt>
            <dd>Minor tasks such as swapping photos, editing text, or adding a single new section.</dd>
            <dt>Additional Work</dt>
            <dd>Changes outside a Small Content Update, including new pages, redesigns, custom features, or integrations.</dd>
            <dt>Fair Market Value (FMV)</dt>
            <dd>A good-faith valuation for purchasing the Website's code/design considering the time and skill to recreate deliverables, prevailing hourly rates, comparable market pricing, and third-party license buyouts/transfer costs.</dd>
            <dt>Term</dt>
            <dd>The initial and any renewal period of the subscription specified in the Order.</dd>
          </dl>
        </section>
        ...
        <section id="s5">
          <h2>5. Ownership; License; Access</h2>
          <ol>
            <li><strong>Client Ownership.</strong> Client owns its Branding and Content.</li>
            <li><strong>Provider Ownership.</strong> Provider owns the Website design, code, templates, components, build scripts, configurations and other IP created or provided by Provider.</li>
            <li><strong>Subscription License.</strong> While the subscription is active, Provider grants Client a limited, non-exclusive, non-transferable license to use and publicly display the Website hosted by Provider for Client's business purposes.</li>
            <li><strong>Administrative Access.</strong> Provider may restrict back-end access to protect platform integrity. Full code/database access is provided only upon Buyout under Section 10.</li>
            <li><strong>No Work-For-Hire.</strong> The Website is not a work-for-hire and no assignment of Provider IP occurs unless and until Buyout is completed.</li>
            <li><strong>Credit and Attribution.</strong> The Website includes a discreet credit in the footer, "Built and maintained by All Done Sites", linking to https://alldonesites.com. This credit is part of the service and remains in place while the subscription is active. Removal can be arranged on request.</li>
          </ol>
        </section>
        ...
        <section id="s7">
          <h2>7. Term; Minimum Commitment; Cancellation</h2>
          <ol>
            <li><strong>Minimum Term.</strong> The standard minimum commitment is twelve (12) months.</li>
            ...
            <li><strong>Early Cancellation.</strong> Client may terminate early but remains liable for all remaining amounts due through the end of the twelve-month term.</li>
            <li><strong>Transfer After Term.</strong> After the initial twelve-month term is satisfied and all amounts are paid, the Website's code and files will be transferred to Client at no additional charge, so the site is Client's to keep or move, subject to the third-party license limitations in Section 10.</li>
        ...
        <section id="s8">
          <h2>8. Fees; Invoicing; No Refunds; Taxes</h2>
          <ol>
        ...
        <section id="s9">
          <h2>9. Non-Payment; Suspension; Data Retention</h2>
          <p>
        ...
        <section id="s10">
          <h2>10. Transfer; Early Buyout; Another Host</h2>
          <ol>
            <li><strong>Included Transfer After Term.</strong> After the initial twelve-month term is satisfied and all amounts are paid, Provider will transfer the Website (design and code) to Client at no additional charge, except for non-transferable third-party licenses described in Section 10.5.</li>
            <li><strong>Early Buyout.</strong> Before the twelve-month term is completed, Client may elect to purchase the Website (design and code) at Fair Market Value (FMV) plus the cost of any Additional Work and third-party license buyouts/transfer fees.</li>
            ...
            <li><strong>Deliverables on Transfer.</strong> On completion of the term (or, for an early buyout, on receipt of payment), Provider will deliver a reasonable export (e.g., code bundle and database dump where applicable) and provide limited transition assistance.</li>
        ...
        <section id="s11">
          <h2>11. Service Levels; Maintenance; Security</h2>
          <ol>
        ...
        <section id="s12">
          <h2>12. Content Standards; Compliance; Data Protection</h2>
          <p>
        ...
        <section id="s13">
          <h2>13. Additional Work; Changes in Scope</h2>
          <p>
        ...
        <section id="s15">
          <h2>15. Warranties; Disclaimers; Limitation of Liability</h2>
          <ol>
        ...
        <section id="s17">
          <h2>17. Suspension; Termination for Cause</h2>
          <p>
        ...
        <section id="s19">
          <h2>19. Entire Agreement; Amendments; Assignment; Notices</h2>
          <p>
