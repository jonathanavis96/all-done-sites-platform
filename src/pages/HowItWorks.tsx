...
export default function HowItWorks() {
  return (
    <div className="container py-16">
      <Seo
        title="How It Works | All Done Sites"
        description="Our simple process: We design, you approve, we launch, we maintain. Hassle-free website subscription for busy business owners."
      />
      <header className="max-w-2xl">
        <h1 className="text-3xl font-bold">Get started in 3 easy steps</h1>
        <p className="mt-2 text-muted-foreground">We make professional websites effortless from day one.</p>
      </header>
